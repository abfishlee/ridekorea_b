...
const styles = StyleSheet.create({
  ...
  cover: { width: "100%", height: 240, backgroundColor: theme.colors.surfaceMuted },
  ...
  spotPhoto: { width: "100%", height: 160, borderRadius: theme.radius.card, backgroundColor: theme.colors.surfaceMuted },
